...
COMPONENT=$1
ENV=$2
HOSTEDZONEID="Z0289106Z0OKQFN4RIG5"
...
SG_ID="$(aws ec2 describe-security-groups  --filters Name=group-name,Values=MY_SECURITY_GROUP | jq '.SecurityGroups[].GroupId' | sed -e 's/"//g')"       # b54-allow-all security group id
